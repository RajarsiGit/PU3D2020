...
<input type="hidden" name="surl" id="surl" value="https://localhost/success.php"> 
<input type="hidden" name="furl" id="furl" value="https://localhost/failed.php"> 
...
<script type="text/javascript">
  jQuery(document).on('click', '#razor-pay-now', function (e) {
    ...
    var store_logo = 'https://localhost/images/logo.png';
